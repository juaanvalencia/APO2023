...
public class NaveExploradora extends NaveEspacial {
    ...
    @Override
    public void cargar() {
        System.out.println("La nave exploradora no tiene carga que cargar.");
    }
    
    @Override
    public void descargar() {
        System.out.println("La nave exploradora no tiene carga que descargar.");
    }
    
    @Override
    public void atacar() {
        System.out.println("La nave exploradora no está armada y no puede atacar.");
    }
}
